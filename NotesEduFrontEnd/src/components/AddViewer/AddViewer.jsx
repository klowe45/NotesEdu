...
import { createViewer } from "../../api/authApi";
import "./AddViewer.css";
...
const AddViewer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!organizationData) {
      setError("You must be logged in as an organization to add viewers");
      return;
    }
    ...
    try {
      ...
      const result = await createViewer(viewerData);
      ...
      // Navigate to viewer list after successful creation
      navigate("/viewer-list");
    } catch (err) {
      console.error("Error creating viewer:", err);
      setError(err.message || "Failed to create viewer. Please try again.");
    } finally {
    ...
    <div className="min-h-screen bg-white-50 p-4 pb-20">
      ...
      <div className="mb-8">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Add Viewer</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              >
                {isSubmitting ? "Creating Viewer..." : "Create Viewer"}
              </button>
            </div>
          </form>
        </div>
