  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.teacher) {
        ...
        console.log("Staff signin successful:", result);
        setLoggedIn(true);
        navigate("/");
        return;
      }

      // Try organization signin
      result = await organizationSignin(credentials);
      ...
      // Try viewer signin
      result = await viewerSignin(credentials);
